...
clearingcodes_df = pd.read_csv("gs://frontier-data-csv/may_clearingcodes_dispositions_field_updated_notnull.csv")
dispatches_celonis_df = pd.read_csv("gs://frontier-data-csv/may_dispatches_celonis_notnull.csv")
disposition_tso_df = pd.read_csv("gs://frontier-data-csv/may_dispositions_tso_updated_notnull.csv")
workflow_tso_df = pd.read_csv("gs://frontier-data-csv/may_workflow_tso_notnull.csv")
hellox_df = pd.read_csv("gs://frontier-data-csv/combined_notnull.csv", low_memory= False)
